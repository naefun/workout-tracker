...
Where applicable, we rely on performance of the service you request, our legitimate interests in operating and securing the app, consent where required, and compliance with legal obligations.
...
We use established authentication providers and reasonable administrative and technical safeguards to protect account information. No storage or transmission method is completely secure, so we cannot guarantee absolute security.
...
Google and Supabase may process information in countries other than the country where you live. Where required, they and we use appropriate safeguards for international transfers under applicable data-protection law.
